...
// PHR
#define CUSTOM_MACHINE_NAME "PH UM 2 32bit"
 ...
 */
// PHR
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.19,80.19,400,778.00}
...
// PHR
 ...
 #define Z_PROBE_OFFSET_FROM_EXTRUDER -2.80   // Z offset: -below +above  [the nozzle]
