...
// PHR
#define CUSTOM_MACHINE_NAME "PH UM 1.1.9"
 ...
 */
// PHR
// #define DEFAULT_AXIS_STEPS_PER_UNIT   {80.19,80.19,400,430.91}  // {80.41,80.43,400,97.84}  // 148 -> 152 pour ne pas avoir a compenser le flux titan 430.91
// titan extruder et TMC2208
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.19,80.19,400,430.91}  // {80.41,80.43,400,97.84}  // 148 -> 152 pour ne pas avoir a compenser le flux titan 430.91
...
// PHR
#if MOTHERBOARD == BOARD_MKS_GEN_13
...
#define Z_SAFE_HOMING
  ...
  // PHR
  #define Z_SAFE_HOMING_X_POINT 100 // ((X_BED_SIZE) / 2)    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT 100 // ((Y_BED_SIZE) / 2)    // Y point for Z homing when homing all axis (G28).
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  // PHR
  #define NOZZLE_PARK_POINT { 0, Y_MAX_POS, (Z_MIN_POS + 1)}
